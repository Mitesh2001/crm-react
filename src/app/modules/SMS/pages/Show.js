...
function Show() {
  ...
  suhbeader.setTitle("SMS Information");
      ...
      <>
        <Tab.Container id="left-tabs-example" defaultActiveKey="summary">
          <div className="lead-head-section mb-5">
                ...
                {info.id && (
                  <ul>
                    <li>
                      ...
                      >
                        <Link to="/contacts" className="abtn text-white">
                    ...
                    <li>
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>Delete sms</Tooltip>}
                      >
                        <Link
                          to="#"
                          className="abtn text-white"
            ...
            <Nav>
              <Nav.Item>
                <Nav.Link eventKey="summary">SMS Summary</Nav.Link>
              </Nav.Item>
            </Nav>
          </div>
