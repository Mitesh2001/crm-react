...
import Filters from "../../Email/partials/Filters";
 ...
 */
  ...
  if (leadredirect) {
    ...
    return (
      <>
        <div className="rk-sub-header mb-5">Send Email to Contacts</div>
          ...
          <Card.Body>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              ...
              <Button
                ...
                className="rk-btn2 rk-btn-icon btn btn-primary btn-sm ml-2"
              >
                <ArrowDropDownIcon />
                Select Columns
              </Button>
