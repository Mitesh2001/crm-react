      ...
      <div style={{ textAlign: "right" }}>
        ...
        >
          ...
          <Button
            ...
            className="rk-btn2 rk-btn-icon btn btn-primary btn-sm ml-12"
          >
            <ArrowDropDownIcon />
            Select Columns
          </Button>
  ...
  return (
    <div>
      ...
      >
        {(props) => (
          <div className="row">
            <div className="col-md-5 ml-2 mr-11">
              <MySearch {...props.searchProps} />
            </div>
            <div className="col-md-5">
              {user.permission &&
                user.permission.State &&
                user.permission.State.map((item) => {
                  return (
                    item.name === "Create" && (
                      <Link
                        to="/master/states/add"
                        className="rk-btn1 btn btn-primary btn-sm"
                        style={{display: "none"}}
                      >
                        <AddIcon />
                        Add State
