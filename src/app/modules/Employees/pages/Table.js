...
export default function Table(props) {
  ...
  //   }
  const checkLimit=()=>{
    if(props.total<user.company_details.no_of_users){
      return true;
    }
    return false;
  }
      ...
      >
        {(props) => (
          <div className="row">
            ...
            <div className="col-md-5 ml-10">
              {user.company_details&&checkValidity(user.company_details.expiry_date) &&checkLimit() &&user.user_permission &&  //&&checkLimit() removed
              ...
              <Link>
                <ExportCSVButton
                  {...props.csvProps}
                  className="rk-btn3 rk-btn-icon btn btn-primary btn-sm mr-3"
                >
                  <CloudDownloadIcon />
                  &nbsp;Export CSV
                </ExportCSVButton>
