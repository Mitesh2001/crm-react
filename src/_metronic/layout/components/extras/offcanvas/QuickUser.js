...
export function QuickUser() {
  ...
  React.useEffect(() => {
    let toggle = document.getElementById("kt_quick_user");
    const toggleBtn = document.getElementById("kt_quick_user_toggle");
    if (toggle && toggle.classList.contains('offcanvas-on')) {
      toggleBtn.click();
    }
  }, [location]);
    ...
    <div id="kt_quick_user" className="offcanvas offcanvas-right offcanvas p-10">
      <div className="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 className="font-weight-bold m-0">
          User Profile
          <small className="text-muted font-size-sm ml-2">Quickview</small>
        </h3>
        <a
          href="#"
      ...
      >
        <div className="d-flex align-items-center mt-5">
          ...
          <div className="d-flex flex-column">
            <div className="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{user.name}</div>
            {user?.occupation && (<div className="text-muted mt-1">{user?.occupation}</div>)}
        ...
        <div className="navi navi-spacer-x-0 p-0">
          <NavLink to="/profile" className="navi-item">
          ...
          <NavLink to="/change-password" className="navi-item">
            <div className="navi-link">
              ...
              <div className="navi-text">
                ...
                <div className="text-muted">You can change your password</div>
              </div>
            </div>
          </NavLink>
